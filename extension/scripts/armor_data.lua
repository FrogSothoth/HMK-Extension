...
Items = {
    ...
    ["Padded Cowl"]      = { material = "Padded", price = 12, weight = 0.5, enc = 5, cov = { Skull = "Y", Neck = "Y" } },
    ...
    ["Quilted Cowl"]     = { material = "Quilted", price = 24, weight = 1.1, enc = 5, cov = { Skull = "Y", Neck = "Y" } },
    ...
    ["Kurbul 3/4 Helm"]  = { material = "Kurbul", price = 35, weight = 5.3, enc = 5, cov = { Skull = "R", Face = "R" } },
    ["Kurbul Spaulders"] = { material = "Kurbul", price = 15, weight = 1.1, enc = 5, cov = { Shoulder = "R" } },
    ["Kurbul Rerebraces"] = { material = "Kurbul", price = 40, weight = 3.0, enc = 5, cov = { ["Upper Arm"] = "R" } },
    ["Kurbul Coudes"]    = { material = "Kurbul", price = 10, weight = 0.8, enc = 5, cov = { Elbow = "R" } },
    ["Kurbul Vambraces"] = { material = "Kurbul", price = 25, weight = 1.9, enc = 5, cov = { Forearm = "R" } },
    ...
    -- SCALE
    ["Scale Cowl"]       = { material = "Scale", price = 60, weight = 3.3, enc = 5, cov = { Skull = "R", Neck = "R" } },
    ["Scale Gauntlets"]  = { material = "Scale", price = 50, weight = 2.8, enc = 5, cov = { Hand = "R" } },
    ...
    -- MAIL
    ["Mail Cowl"]        = { material = "Mail", price = 90, weight = 2.7, enc = 5, cov = { Skull = "R", Neck = "R" } },
    ["Mail Mittens"]     = { material = "Mail", price = 75, weight = 2.3, enc = 5, cov = { Hand = "R" } },
    ...
    ["Plate 3/4 Helm"]   = { material = "Plate", price = 140, weight = 5.3, enc = 5, cov = { Skull = "R", Face = "R" } },
    ["Plate Great Helm"] = { material = "Plate", price = 180, weight = 6.8, enc = 10, cov = { Skull = "R", Face = "R", Neck = "R" } },
    ["Plate Spaulders"]  = { material = "Plate", price = 60, weight = 1.1, enc = 5, cov = { Shoulder = "R" } },
    ["Plate Rerebraces"] = { material = "Plate", price = 160, weight = 3.0, enc = 5, cov = { ["Upper Arm"] = "R" } },
    ["Plate Coudes"]     = { material = "Plate", price = 40, weight = 0.8, enc = 5, cov = { Elbow = "R" } },
    ["Plate Vambraces"]  = { material = "Plate", price = 100, weight = 1.9, enc = 5, cov = { Forearm = "R" } },
